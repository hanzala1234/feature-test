...
gcloud run deploy feature-${FEATURE_ID} --update-env-vars $env_vars --image gcr.io/$PROJECT_ID/feature-${FEATURE_ID}:${COMMIT_SHA}  --allow-unauthenticated --region us-central1 --platform managed --port 8080
